      ...
      child: Scaffold(
        ...
        slivers: [
          ...
          SliverList(
            ...
            listCardWidget("Nome Corso", _class.name),
            listCardWidget("Codice", _class.code),
            listCardWidget("Settore", _class.sector),
            listCardWidget("CFU", _class.cfu.toString()),
            listCardWidget("Anno", "${_class.courseYear}°"),
            listCardWidget(
                "Prerequisiti",
